	...
	<div class="data_area">
		...
		<div class="content_class">
			<center>
				...
				<div id="map_info">
					...
					<p id="polygon_area">0.00㎡</p>
					<form id="mapForm">
						コメント欄<br>
						<textarea id="formComment"></textarea>
						<br>
						<input type="button" value="送信" onclick="map_send();"/>
					</form>
				</div>
			</center>
		</div>
		<div class="site_fooder">
			<div id="site_description">
				<h2>サイト概要</h2>
				<p>本サイトは、大分県内の各地域の気温、降水量、風向、風速、日照時間、さらには天気予報までもが一目で確認できるお天気情報サイトです。また、お好きな農地にコメントをすることができ、それによって県内の農家の方々のコミュニケーションを支えます。</p>
				<p>私たちのポリシーは、「万人が喜ぶ世界を作ろう」でございます。本サイトは、まったくの非営利でございますので、安心してお使いいただけます。また、本サイトはGUIに非常に優れておりますので、小さなお子様やご高齢の方でも特に問題なくお使いいただけるかと思います。</p>
				<p>this site provides temperature, quantity of rain, wind direction, wind speed, sun time and weather forecasts in each regions of oita prefecture. and you can comment to places where you like,in this way we help communication of people in your prefecture.</p>
				<p>our policy is "We make a world which all people were pleasured".this site is complete non-profit , so you can use safely. in addition , this site is superior to use GUI , therefore we think all people can use regardless of your old.</p>
				<p>Author　Nakaoka</p>
			</div>
		</div>
	</div>
